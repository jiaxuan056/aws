        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active position-relative">
                    <img src="https://jiaxuanbucket.s3.us-east-1.amazonaws.com/banner.jpg" class="d-block w-100" alt="Product Banner">
                            ...
                            <div class="row">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo '      <img src="https://jiaxuanbucket.s3.us-east-1.amazonaws.com/' . htmlspecialchars($row['image_url']) . '" class="img-fluid" alt="">';
                                        echo '      <ul>';
